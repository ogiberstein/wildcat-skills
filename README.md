...
| [Horos](./plugins/horos) | Classifying a repository's token sinks with evidence and emitting the reading boundary agents respect. | The classifier refinement the maintainer specified and the three-repository boundary marking remain from the reopened scope; map now reads Solidity. |
