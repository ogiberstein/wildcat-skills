...
| [Horos](./plugins/horos) | Classifying a repository's token sinks with evidence and emitting the reading boundary agents respect. | A repository's walk-worthiness and its missing extractors are still decided by guesswork; scan records no per-filetype breakdown. |
