...
| [Horos](./plugins/horos) | Classifying a repository's token sinks with evidence and emitting the reading boundary agents respect. | One job remains from the reopened scope: committed boundaries and censuses across the three home repositories, using the refined classifier. |
