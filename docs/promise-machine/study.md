...
| Chunk | `chunk-v0.1.0` | canonical skill | Inputs become validated source-linked chunks; not embeddings, retrieval or correct answers | Markdown/Solidity suites; callable ABI frontier open |
