# The first end-to-end Goldfinch preservation release
...
5. The Goldfinch fixture at `plugins/lazarus/examples/goldfinch-v0` is the
...
> end-to-end Goldfinch preservation release without upgrading recorded RPC
...
**The gap, reproduced before this run started.** Take the shipped Goldfinch
...
```bash
python3 plugins/lazarus/scripts/lazarus.py verify plugins/lazarus/examples/goldfinch-v0
python3 plugins/ariadne/scripts/ariadne.py capture-state-fixture \
  --fixture plugins/lazarus/examples/goldfinch-v0 --name goldfinch-v0 \
...
python3 plugins/lazarus/scripts/lazarus.py release \
  plugins/lazarus/examples/goldfinch-v0 --statement statement.json --out release/
...
**Elsewhere in the marketplace.** The Goldfinch market and transaction in the
fixture were selected from the first row of Tabularium's checked-in Goldfinch
...
- Re-capturing the Goldfinch fixture. It is checked in and this run reads it.
...
- Edit the checked-in Goldfinch fixture's captured bytes.
...
- `plugins/lazarus/examples/goldfinch-v0/README.md`, for the fixture's
