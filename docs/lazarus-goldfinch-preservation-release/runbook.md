# Runbook: the first end-to-end Goldfinch preservation release
...
**Entry.** The run branch `fiat/the-first-end-to-end-goldfinch-preservation-rele`
off `main` at `382fdc0`.
...
- `docs/lazarus-goldfinch-preservation-release/study.md` and `runbook.md` (new,
...
**Tests.** The shipped Goldfinch fixture and a statement over it, binding clean.
...
**Tests.** The Goldfinch fixture released clean. The study's tampered manifest
...
**Goal.** Produce the Goldfinch preservation release, demonstrate the whole
...
- `plugins/lazarus/examples/goldfinch-v0-release/` (new)
- `plugins/lazarus/examples/goldfinch-v0/demo.py` and `README.md`
